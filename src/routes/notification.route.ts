...
router.post("/broadcast", notificationController.broadcastNotification as RequestHandler);
router.post("/schedule", notificationController.scheduleNotification as RequestHandler);
router.get("/analytics", notificationController.getNotificationAnalytics as RequestHandler);

// Utility endpoints
router.get("/types", notificationController.getNotificationTypes as RequestHandler);
router.post("/test-push", notificationController.testPushNotification as RequestHandler);
